...
namespace umbriel {
  ...
  namespace {
    ...
    constexpr ActionSpec kActionSpecs[] = {
        ...
        {"column-move-to-workspace", "<workspace>[/<output>]", KeybindAction::ColumnMoveToWorkspace,
         ActionArgKind::Workspace},
        {"column-move-to-workspace-next", "", KeybindAction::ColumnMoveToWorkspaceNext},
        {"column-move-to-workspace-previous", "", KeybindAction::ColumnMoveToWorkspacePrevious},
        ...
        {"window-move-to-workspace", "<workspace>[/<output>]", KeybindAction::WindowMoveToWorkspace,
         ActionArgKind::Workspace},
        {"window-move-to-workspace-back-and-forth", "", KeybindAction::WindowMoveToWorkspaceBackAndForth},
        ...
        {"window-toggle-scratchpad", "[<output>]", KeybindAction::WindowToggleScratchpad,
         ActionArgKind::OptionalOutput},
        {"workspace-back-and-forth", "", KeybindAction::WorkspaceBackAndForth},
